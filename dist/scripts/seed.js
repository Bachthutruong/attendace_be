...
const seedDatabase = async () => {
    try {
        ...
        await Attendance_1.default.deleteMany({});
        ...
        const employees = await User_1.default.create([
            {
                employeeCode: 'NV001',
                name: 'Vũ Duy Bách',
        ...
        for (let i = 0; i < 7; i++) {
            ...
            for (const employee of employees.slice(0, 3)) {
                ...
                await Attendance_1.default.create({
                    ...
                    workedHours,
                    status: 'completed',
                    hasDeviceAlert: i === 0 && employee === employees[0],
                    hasIpAlert: i === 0 && employee === employees[0],
                    alertMessage: i === 0 && employee === employees[0]
